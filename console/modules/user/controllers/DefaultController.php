...
{
    /**
     * @var \@frontend\modules\user\Module
     * @inheritdoc
     */
    public $module;
    ...
    {
        /** @var \@frontend\modules\user\models\forms\LoginForm $model */
    ...
    {
        /** @var \@frontend\modules\user\models\forms\LoginEmailForm $loginEmailForm */
    ...
    public function actionLoginCallback($token)
    {
        ...
        /** @var \@frontend\modules\user\models\Role $role */
     ...
     * @param \@frontend\modules\user\models\User $user
     */
    ...
    {
        /** @var \@frontend\modules\user\models\forms\ResendForm $model */
    ...
    {
        /** @var \@frontend\modules\user\models\forms\ForgotForm $model */
